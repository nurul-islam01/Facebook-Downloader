    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btn_postjob.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                PostJob postJob=new PostJob(jb_title,jb_budget,jb_address,jb_phone,jb_description,date_start,date_end,mDate,id, userId, Category.TUTION_JOBS, postCat, false);
