...
public class TutionServiceCreateFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TuitionServiceCreate= FirebaseConfig.saveService();
        ...
        btnPostService.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String serviceCat =serviceCategory.getSelectedItem().toString().trim();
                ...
                Services services=new Services(title,budget,skills,phone,description,mDate,id, uid, Category.TUTION_SERVICE, serviceCat, false);
