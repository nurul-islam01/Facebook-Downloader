...
public class ItandSoftwareJobServiceCreateFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ItAndSoftwareCreateService= FirebaseConfig.saveService();
        ...
        btnPostService.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Services services=new Services(title,budget,skills,phone,description,mDate,id, uid, Category.IT_SERVICE, serviceCat, false);

                ItAndSoftwareCreateService.child(id).setValue(services).addOnCompleteListener(new OnCompleteListener<Void>() {
                    @Override
