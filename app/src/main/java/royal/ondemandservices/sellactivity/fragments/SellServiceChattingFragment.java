 ...
 */
public class SellServiceChattingFragment extends Fragment implements SellServiceInterface {
    ...
    public SellServiceChattingFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_sell_service_chatting, container, false);
